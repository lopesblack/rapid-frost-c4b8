...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/teste)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/teste
```

A live public deployment of this template is available at [https://teste.templates.workers.dev](https://teste.templates.workers.dev)
